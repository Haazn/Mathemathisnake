...
const MAX_UNLOCKED_LEVEL_KEY_IN_MENU = 'maxUnlockedLevel_triangles';
...
function showQuestionUI(){ 
  ...
  questionTextElement.style.marginLeft = "0.5vw";
...
function goBackToMenu() { window.location.href = "../../geometrytrianglelevel.html"; }