...
const MAX_UNLOCKED_LEVEL_KEY_IN_MENU = 'maxUnlockedLevel_pemdas';
...
function showQuestionUI(){ 
  questionTextElement.style.fontSize = "3.5vw";
...
function goBackToMenu() { window.location.href = "../../algebrapemdaslevel.html"; }