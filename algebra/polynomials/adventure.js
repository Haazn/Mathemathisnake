...
const MAX_UNLOCKED_LEVEL_KEY_IN_MENU = 'maxUnlockedLevel_polynomials';
...
function showQuestionUI(){ 
   questionTextElement.style.fontSize = "2.70vw";
  questionTextElement.style.marginTop = "13vw";
...
function goBackToMenu() { window.location.href = "../../algebrapolynomialslevel.html"; }