...
const MAX_UNLOCKED_LEVEL_KEY_IN_MENU = 'maxUnlockedLevel_mean';
...
function showQuestionUI(){ 
    questionTextElement.style.marginTop = "12vw";
    questionTextElement.style.fontSize = "3vw";
...
function adjustQuestionFontSize() {
    ...
    const styleConfigs = [
        ...
        { threshold: Infinity, fontSize: "clamp(1.2vw, 1.8vw, 30px)", centerText: false } 
    ];
...
function goBackToMenu() { window.location.href = "../../statisticsmeanlevel.html"; }